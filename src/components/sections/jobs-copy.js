...
const Jobs = ({ data }) => {
  ...
  const DATA = [
    { title: 'Group Lead', ur: 'asd.asd.asd', company: 'Wipro', range: 'Asdasdasd' },
    { title: 'sdasdad', ur: 'asd.asd.asd', company: 'ompay', range: 'Asdasdasd' },
  ];
          ...
          data.map(({ node }, i) => {
            ...
            return (
              <StyledTabContent
                ...
                {DATA && DATA.length ? (
                  renderJobDescription(DATA, html)
                ) : (
                  <>
                    <StyledJobTitle>
                      <span>{title}</span>
  ...
  function renderJobDescription(data, html) {
    return data.map(({ title, url, company, range }) => (
      <>
        <StyledJobTitle>
          <span>{title}</span>
          <StyledCompany>
